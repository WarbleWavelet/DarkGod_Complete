...
public class MainCitySys : SystemRoot 
{
    ...
    public void SetMoveDir(Vector2 dir)
    {
        ...
        {
            playerCtrl.SetAniBlend(Constants.BlendRun);
        }
        playerCtrl.Dir = dir;
    ...
    void RunNavTask()
    {
        ...
        { 
            nav.enabled = true;
        //
            nav.speed = Constants.PlayerRunSpeed;
            nav.SetDestination(navTarget.position);
            playerCtrl.SetAniBlend(Constants.BlendRun);
            playerCtrl.Dir = (navTarget.position - playerCtrl.gameObject.transform.position).normalized; //加的
        }
    }
