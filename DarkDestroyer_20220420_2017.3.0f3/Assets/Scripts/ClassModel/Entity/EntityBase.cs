...
public class EntityBase :IStateProcessor  , IControllerProcessor
{
    ...
    public EAniState CurState = EAniState.Idle;
    ...
    {
        stateMgr.ChangeStaus(this, EAniState.Move, null);
    }

    public void StateIdle()
    {
        stateMgr.ChangeStaus(this, EAniState.Idle, null);
    }
    public void StateBorn()
    {
        stateMgr.ChangeStaus(this, EAniState.Born, null);
    }
    public void StateAttack(int skillID)
    {
        stateMgr.ChangeStaus(this, EAniState.Attack, skillID);
    }

    public void StateDie( )
    {
        stateMgr.ChangeStaus(this, EAniState.Die, null);
    }

    public void StateHit()
    {
        stateMgr.ChangeStaus(this, EAniState.Hit, null);
    }
    #endregion
