...
public class DefinePath
{
    ...
    //public static string ProjectPath = CommonClass.TrimName(Application.dataPath, TrimNameType.SlashAfter) ;
    ...
    public static string assetbundleconfig_Inner = RealFramePath + "StreamingAssets/"+ CommonClass.BuildTarget + "/assetbundleconfig"; //bytes路径的AB包路径
    public static string Path_AB_Inner = RealFramePath + "StreamingAssets/"+ CommonClass.BuildTarget + "/"; 
